...
class SessaoServiceTest {
        ...
        void init() {
                ...
                sessao30Seg = Sessao.builder()
                                ...
                                .finalSessao(LocalDateTime.parse("2025-01-01 12:00:30", dateTimeFormatter))
                                .build();

                sessaoInicioIgualFinal = Sessao.builder()
                                .inicioSessao(LocalDateTime.parse("2025-01-01 12:00:00", dateTimeFormatter))
                                .finalSessao(LocalDateTime.parse("2025-01-01 12:00:00", dateTimeFormatter))
                                .build();

                sessaoFinalAntesInicio = Sessao.builder()
                                .inicioSessao(LocalDateTime.parse("2025-01-01 12:00:00", dateTimeFormatter))
                                .finalSessao(LocalDateTime.parse("2025-01-01 11:00:00", dateTimeFormatter))
                                .build();
        }
        ...
        void deveRetornarSessaoComDuracaoPadraoParaSessaoComDuracaoInferiorA60Segundos() {
                ...
                assertAll("validar duração de sessão",
                                ...
                                () -> assertEquals(sessao30Seg.getInicioSessao().plusMinutes(1),
                                                sessao.getFinalSessao()));
        }
        ...
        void deveRetornarSessaoComDuracaoPadraoParaSessaoComHoraInicioIgualAHoraFinal() {
                ...
                assertAll("validar duração de sessão",
                                ...
                                () -> assertEquals(sessaoInicioIgualFinal.getInicioSessao().plusMinutes(1),
                                                sessao.getFinalSessao()));
        }
