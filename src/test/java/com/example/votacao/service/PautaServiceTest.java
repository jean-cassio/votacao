...
class PautaServiceTest {
    ...
    void init() {
        ...
        pauta = Pauta.builder()
                ...
                .dataCriacao(LocalDateTime.parse("2025-01-01 00:00:00", dateTimeFormatter))
                .sessao(sessao)
                .ativo(true)
                .build();

        sessao = Sessao.builder()
                .inicioSessao(LocalDateTime.parse("2025-01-01 00:00:00", dateTimeFormatter))
                .finalSessao(LocalDateTime.parse("2025-01-01 00:01:00", dateTimeFormatter))
                .build();
